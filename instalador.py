...
if (-not $packageInstalled) {
    ...
    & pip install --trusted-host pypi.org --trusted-host files.pythonhosted.org "G:\\Desenvolvimento Farmacotecnico Neo\\59. Softwares_Farmacotecnico\\Arquivos\\PyQt5-5.15.9-cp37-abi3-win_amd64.whl" db-sqlite3 pandas numpy unidecode fpdf email-to
} else {
